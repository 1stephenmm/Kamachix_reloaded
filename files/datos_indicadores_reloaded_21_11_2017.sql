...
--
-- Definition for function fun_actua_formacion (OID = 22888) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function fun_actua_relacion (OID = 22889) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function fun_delete_cohort (OID = 22890) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function fun_delete_period (OID = 22891) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function Actua_Estudiantes_Dep (OID = 22892) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function Actua_Formacion_Dep (OID = 22893) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function Fun_Actua_KPI_Est_Doc (OID = 22894) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function Fun_Actua_KPI_Est_Doc_UDENAR (OID = 22895) : 
--
			 ...
			 ELSE
				...
				ELSE
					...
					SET 
						estudiantes=(
							SELECT 
								sum(matriculados)::numeric(5,0)
							FROM estudiantes_departamento 
							WHERE 
								anho=NEW.anho),
						docentestc=(
							SELECT 
								(sum(t_completo))::numeric(3,0)
							FROM formacion_departamento 
							WHERE 
								anio=NEW.anho
                            AND
					...
					SET 
						razona=(
							...
							FROM 
								...
								SELECT 
									anho,
									sum(matriculados)::numeric(5,0) AS e
								FROM estudiantes_departamento 
								WHERE 
									anho=NEW.anho
								GROUP BY anho) t1
							JOIN 
								...
								SELECT 
									anio,
									(sum(t_completo)+sum(t_ocasional))::numeric(5,0) AS d
								FROM formacion_departamento 
								WHERE 
									anio=NEW.anho
                            	AND
...
LANGUAGE plpgsql;
--
-- Definition for function Fun_Actua_KPI_Form (OID = 22896) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function fun_actua_satisfaccion (OID = 22897) : 
--
...
LANGUAGE plpgsql;
--
-- Structure for table KPI_Acreditacion (OID = 22898) : 
--
SET search_path = "Datawarehouse", pg_catalog;
...
WITH (oids = false);
--
-- Structure for table KPI_Desercion_Cohorte (OID = 22902) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Desercion_Periodo (OID = 22906) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Formacion (OID = 22910) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Nivel_Satisfaccion (OID = 22914) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Relacion_Docentes (OID = 22918) : 
--
...
WITH (oids = false);
--
-- Structure for table acreditacion_alta_calidad (OID = 22922) : 
--
SET search_path = public, pg_catalog;
...
WITH (oids = false);
--
-- Structure for table estudiantes_departamento (OID = 22945) : 
--
...
WITH (oids = false);
--
-- Structure for table formacion (OID = 22949) : 
--
...
WITH (oids = false);
--
-- Structure for table formacion_departamento (OID = 22954) : 
--
...
WITH (oids = false);
--
-- Structure for table manuales_indicadores (OID = 22958) : 
--
...
WITH (oids = false);
--
-- Structure for table programas (OID = 22964) : 
--
...
WITH (oids = false);
--
-- Structure for table users (OID = 22969) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Estudiantes_por_Docentes_TC (OID = 22976) : 
--
SET search_path = "Datawarehouse", pg_catalog;
...
20128	11632	2015-12-10	4	t	99	0	f	f	t	f	f	f	f	f	f	f	f
13752	783	2015-09-02	4	t	20	1	t	f	t	f	f	f	f	f	f	f	f
13753	16841	2015-09-02	4	t	23	1	t	f	t	f	f	f	f	f	f	f	f
14315	777	2015-09-07	4	t	28	1	t	f	f	f	f	f	f	f	f	f	f
\.
...
15	2011	247	7	0	35	32	38	5  
3 	2011	278	8	6	20	22	18	5  
4 	2010	281	6	2	35	32	38	5  
16	2010	144	5	1	24	30	18	5  
28	2010	188	8	1	21	22	20	5  
21	2011	146	11	2	11	12	10	5  
5 	2010	307	10	4	22	22	22	5  
17	2010	239	2	1	80	105	55	5  
27	2011	501	7	1	63	67	59	5  
6 	2010	245	10	2	20	23	17	5  
29	2010	241	8	0	30	31	29	5  
10	2011	186	6	0	31	35	27	5  
18	2010	369	12	4	23	41	5	5  
4 	2011	294	6	2	37	34	40	5  
7 	2010	536	10	6	34	37	31	5  
16	2011	132	5	0	26	28	24	5  
30	2010	184	5	0	37	33	41	5  
19	2010	302	10	0	30	28	32	5  
8 	2010	735	5	2	105	106	104	5  
UD	2010	10004	268	59	31	31	31	5  
20	2010	309	25	5	10	10	10	5  
9 	2010	254	5	2	36	0	72	5  
22	2011	684	9	1	68	85	51	5  
10	2010	182	6	2	23	21	25	5  
21	2010	129	11	2	10	10	10	5  
5 	2011	272	10	4	19	18	20	5  
11	2011	216	11	2	17	15	19	5  
11	2010	188	12	2	13	12	14	5  
22	2010	679	8	0	85	81	89	5  
12	2010	0	6	0	0	0	0	5  
17	2011	254	2	1	85	78	92	5  
23	2010	510	15	3	28	27	29	5  
13	2010	362	16	2	20	22	18	5  
28	2011	203	8	1	23	24	22	5  
6 	2011	280	10	3	22	23	21	5  
1 	2010	310	12	1	24	23	25	5  
24	2010	522	11	1	44	49	39	5  
14	2010	324	6	4	32	33	31	5  
2 	2010	534	9	3	45	41	49	5  
12	2011	0	6	2	0	0	0	5  
25	2010	567	9	4	44	44	44	5  
15	2010	215	6	0	36	39	33	5  
3 	2010	275	9	5	20	19	21	5  
23	2011	609	15	2	36	35	37	5  
26	2010	362	7	2	40	49	31	5  
7 	2011	488	10	5	33	32	34	5  
18	2011	142	12	2	10	13	7	5  
27	2010	516	7	2	57	64	50	5  
13	2011	394	16	2	22	20	24	5  
1 	2011	340	12	1	26	26	26	5  
29	2011	271	8	0	34	36	32	5  
8 	2011	733	5	2	105	123	87	5  
24	2011	496	11	1	41	44	38	5  
19	2011	320	10	1	29	31	27	5  
2 	2012	548	9	1	55	46	64	5  
2 	2011	552	9	2	50	47	53	5  
9 	2011	439	4	0	110	108	112	5  
14	2011	317	6	5	29	32	26	5  
3 	2012	260	8	6	19	17	21	5  
30	2011	190	5	2	27	34	20	5  
25	2011	530	9	4	41	44	38	5  
20	2011	350	25	4	12	12	12	5  
UD	2011	10213	267	55	32	32	32	5  
26	2011	357	7	2	40	41	39	5  
1 	2012	366	12	1	28	27	29	5  
4 	2012	302	6	2	38	36	40	5  
5 	2012	270	10	2	23	22	24	5  
6 	2012	332	10	3	26	28	24	5  
7 	2012	459	9	5	33	35	31	5  
8 	2012	743	5	4	83	98	68	5  
9 	2012	458	4	1	92	91	93	5  
10	2012	183	5	1	31	39	23	5  
11	2012	207	10	1	19	19	19	5  
12	2012	200	5	2	29	31	27	5  
13	2012	431	15	3	24	24	24	5  
14	2012	318	7	3	32	31	33	5  
15	2012	242	7	1	30	28	32	5  
16	2012	138	5	1	23	24	22	5  
17	2012	259	2	1	86	85	87	5  
18	2012	132	12	4	8	10	6	5  
19	2012	109	10	1	10	8	12	5  
20	2012	385	25	2	14	14	14	5  
21	2012	153	11	1	13	13	13	5  
22	2012	668	9	1	67	73	61	5  
23	2012	647	15	3	36	35	37	5  
24	2012	478	11	1	40	42	38	5  
25	2012	578	9	4	44	45	43	5  
26	2012	354	8	2	35	38	32	5  
27	2012	489	7	3	49	58	40	5  
28	2012	208	8	2	21	25	17	5  
29	2012	257	8	1	29	34	24	5  
30	2012	202	5	3	25	32	18	5  
UD	2012	10384	267	59	32	32	32	5  
2 	2013	559	10	4	40	44	36	5  
4 	2013	305	6	2	38	38	38	5  
5 	2013	238	11	2	18	19	17	5  
6 	2013	360	11	5	23	23	23	5  
7 	2013	399	9	6	27	27	27	5  
8 	2013	703	5	3	88	102	74	5  
9 	2013	457	4	1	91	90	92	5  
24	2014	538	11	1	45	46	44	5  
25	2013	538	10	4	38	41	35	5  
13	2013	440	15	5	22	21	23	5  
4 	2014	338	6	2	42	46	38	5  
26	2013	338	8	3	31	36	26	5  
14	2013	295	7	3	30	34	26	5  
11	2014	219	18	2	11	18	4	5  
18	2014	124	13	1	9	11	7	5  
15	2013	244	7	1	31	28	34	5  
27	2013	433	7	3	43	51	35	5  
30	2015	207	6	1	30	31	29	5  
25	2014	559	10	3	43	41	45	5  
5 	2014	236	11	1	20	20	20	5  
16	2013	118	5	2	17	21	13	5  
28	2013	211	8	1	23	23	23	5  
12	2014	229	5	1	38	33	43	5  
17	2013	256	2	1	85	79	91	5  
3 	2015	353	7	3	35	31	39	5  
29	2013	250	8	2	25	27	23	5  
19	2014	120	11	0	11	10	12	5  
18	2013	128	12	4	8	9	7	5  
6 	2014	447	11	3	32	36	28	5  
30	2013	189	5	3	24	22	26	5  
1 	2013	383	12	1	29	29	29	5  
19	2013	122	10	2	10	10	10	5  
UD	2013	10342	268	66	31	31	31	5  
3 	2013	326	8	4	27	24	30	5  
20	2013	417	26	2	15	17	13	5  
13	2014	476	7	3	48	25	71	5  
26	2014	320	7	3	32	34	30	5  
1 	2015	408	11	4	27	32	22	5  
21	2013	161	11	2	12	13	11	5  
7 	2014	385	9	3	32	32	32	5  
22	2013	664	9	0	74	69	79	5  
20	2014	417	26	2	15	15	15	5  
23	2013	637	15	2	37	39	35	5  
14	2014	288	8	2	29	28	30	5  
10	2013	189	5	2	27	29	25	5  
8 	2014	691	5	3	86	85	87	5  
24	2013	521	11	1	43	43	43	5  
11	2013	196	11	1	16	16	16	5  
27	2014	444	7	1	56	52	60	5  
12	2013	213	5	2	30	32	28	5  
21	2014	165	10	1	15	17	13	5  
1 	2014	390	11	2	30	28	32	5  
15	2014	257	7	0	37	34	40	5  
9 	2014	463	4	2	77	90	64	5  
5 	2015	227	11	1	19	17	21	5  
2 	2014	541	10	2	45	38	52	5  
7 	2015	335	10	0	34	40	28	5  
28	2014	208	8	1	23	22	24	5  
10	2014	195	5	1	33	34	32	5  
22	2014	695	10	0	70	75	65	5  
3 	2014	316	7	4	29	30	28	5  
16	2014	138	5	1	23	25	21	5  
9 	2015	494	3	3	82	97	67	5  
29	2014	247	8	1	27	26	28	5  
17	2014	266	2	2	67	62	72	5  
23	2014	613	15	1	38	40	36	5  
2 	2015	543	10	2	45	42	48	5  
30	2014	190	6	1	27	29	25	5  
4 	2015	340	7	4	31	31	31	5  
UD	2014	10621	269	45	34	33	35	5  
11	2015	257	11	1	21	21	21	5  
UD	2015	11072	270	54	34	35	33	5  
6 	2015	554	11	5	35	36	34	5  
8 	2015	677	6	1	97	119	75	5  
10	2015	212	6	1	30	36	24	5  
12	2015	250	4	1	50	68	32	5  
13	2015	509	14	5	27	29	25	5  
14	2015	295	8	1	33	35	31	5  
15	2015	234	6	2	29	32	26	5  
17	2015	291	2	2	73	90	56	5  
16	2015	163	5	0	33	37	29	5  
18	2015	142	13	1	10	11	9	5  
19	2015	107	11	0	10	10	10	5  
20	2015	430	27	1	15	16	14	5  
21	2015	185	11	2	14	16	12	5  
22	2015	724	11	2	56	68	44	5  
23	2015	659	13	2	44	43	45	5  
24	2015	585	11	2	45	47	43	5  
25	2015	572	10	6	36	38	34	5  
26	2015	318	7	2	35	38	32	5  
27	2015	416	8	0	52	65	39	5  
28	2015	223	8	2	22	25	19	5  
29	2015	256	7	2	28	30	26	5  
3 	2016	305	8	5	23	22	24	5  
4 	2016	344	7	3	34	33	35	5  
5 	2016	245	10	1	22	21	23	5  
6 	2016	653	11	7	36	32	40	5  
7 	2016	352	8	0	44	42	46	5  
8 	2016	639	7	6	49	43	55	5  
10	2016	225	6	1	32	35	29	5  
11	2016	252	10	1	23	22	24	5  
12	2016	251	3	2	50	52	48	5  
13	2016	532	17	2	28	27	29	5  
14	2016	308	8	0	39	39	39	5  
15	2016	248	6	0	41	38	44	5  
17	2016	312	2	5	45	74	16	5  
18	2016	148	13	1	11	13	9	5  
6 	2017	692	11	2	53	53	0	5  
7 	2017	370	8	0	46	46	0	5  
20	2016	451	27	0	17	17	17	5  
8 	2017	657	6	5	60	60	0	5  
21	2016	182	12	1	14	16	12	5  
9 	2017	541	3	4	77	77	0	5  
10	2017	251	6	0	42	42	0	5  
22	2016	734	9	2	67	66	68	5  
11	2017	238	10	1	22	22	0	5  
12	2017	293	3	2	59	59	0	5  
23	2016	717	12	3	48	48	48	5  
1 	2016	373	11	2	29	26	32	5  
13	2017	528	17	3	26	26	0	5  
2 	2016	557	10	2	46	42	50	5  
24	2016	610	11	1	51	53	49	5  
14	2017	335	7	0	48	48	0	5  
15	2017	302	6	1	43	43	0	5  
25	2016	568	10	6	36	39	33	5  
16	2017	186	3	2	37	37	0	5  
17	2017	291	2	5	42	42	0	5  
26	2016	299	7	2	33	35	31	5  
18	2017	163	13	1	12	12	0	5  
27	2016	450	8	0	56	60	52	5  
19	2017	96	11	0	9	9	0	5  
9 	2016	526	3	4	75	83	67	5  
20	2017	462	27	0	17	17	0	5  
28	2016	237	8	1	26	25	27	5  
21	2017	196	12	1	15	15	0	5  
22	2017	765	8	0	96	96	0	5  
29	2016	258	7	2	29	31	27	5  
23	2017	775	12	0	65	65	0	5  
30	2016	198	6	2	25	22	28	5  
24	2017	659	11	2	51	51	0	5  
UD	2016	11321	270	58	35	33	37	5  
1 	2017	419	11	0	38	38	0	5  
16	2016	172	3	2	34	39	29	5  
2 	2017	500	9	0	56	56	0	5  
25	2017	622	10	5	41	41	0	5  
3 	2017	311	8	4	26	26	0	5  
4 	2017	324	6	4	32	32	0	5  
26	2017	317	7	2	35	35	0	5  
27	2017	478	8	0	60	60	0	5  
19	2016	121	11	0	11	8	14	5  
5 	2017	241	10	0	24	24	0	5  
28	2017	265	7	0	38	38	0	5  
29	2017	275	8	1	31	31	0	5  
30	2017	178	6	2	22	22	0	5  
UD	2017	11730	266	47	37	37	0	5  
\.
--
-- Definition for index KPI_Desercion_Cohorte_idx (OID = 22981) : 
--
ALTER TABLE ONLY "KPI_Desercion_Cohorte"
    ADD CONSTRAINT "KPI_Desercion_Cohorte_idx"
    PRIMARY KEY (programa, periodo);
--
-- Definition for index KPI_Desercion_Periodo_idx (OID = 22983) : 
--
ALTER TABLE ONLY "KPI_Desercion_Periodo"
    ADD CONSTRAINT "KPI_Desercion_Periodo_idx"
    PRIMARY KEY (programa, periodo);
--
-- Definition for index KPI_Nivel_Satisfaccion_pkey (OID = 22985) : 
--
ALTER TABLE ONLY "KPI_Nivel_Satisfaccion"
    ADD CONSTRAINT "KPI_Nivel_Satisfaccion_pkey"
    PRIMARY KEY ("Programa", "Anho");
--
-- Definition for index acreditacion_alta_calidad_pkey (OID = 22987) : 
--
SET search_path = public, pg_catalog;
...
--
-- Definition for index KPI_Formacion_fk1 (OID = 23026) : 
--
ALTER TABLE ONLY "KPI_Formacion"
    ADD CONSTRAINT "KPI_Formacion_fk1"
    FOREIGN KEY ("manual_Formacion") REFERENCES public.manuales_indicadores(codigo);
--
-- Definition for index KPI_Nivel_Satisfaccion_fk (OID = 23031) : 
--
ALTER TABLE ONLY "KPI_Nivel_Satisfaccion"
    ADD CONSTRAINT "KPI_Nivel_Satisfaccion_fk"
    FOREIGN KEY (manual) REFERENCES public.manuales_indicadores(codigo);
--
-- Definition for index KPI_Period_Dropout_fk (OID = 23036) : 
--
ALTER TABLE ONLY "KPI_Desercion_Periodo"
    ADD CONSTRAINT "KPI_Period_Dropout_fk"
    FOREIGN KEY (programa) REFERENCES public.programas(snies);
--
-- Definition for index KPI_Relacion_Docentes_fk (OID = 23041) : 
--
...
--
-- Definition for index KPI_Satisfaction_level_fk (OID = 23046) : 
--
ALTER TABLE ONLY "KPI_Nivel_Satisfaccion"
    ADD CONSTRAINT "KPI_Satisfaction_level_fk"
    FOREIGN KEY ("Programa") REFERENCES public.programas(snies);
--
-- Definition for index acreditacion_alta_calidad_fk (OID = 23051) : 
--
SET search_path = public, pg_catalog;
ALTER TABLE ONLY acreditacion_alta_calidad
...
--
-- Definition for index estudiantes_departamento_fk (OID = 23056) : 
--
...
--
-- Definition for index formacion_departamento_fk (OID = 23061) : 
--
ALTER TABLE ONLY formacion_departamento
    ADD CONSTRAINT formacion_departamento_fk
    FOREIGN KEY (departamento) REFERENCES users(codigo);
--
-- Definition for index formacion_fk (OID = 23066) : 
--
ALTER TABLE ONLY formacion_departamento
    ADD CONSTRAINT formacion_fk
    FOREIGN KEY (formacion) REFERENCES formacion(cod_formacion);
--
-- Definition for index KPI_Estudiantes_por_Docentes_TC_fk (OID = 23071) : 
--
SET search_path = "Datawarehouse", pg_catalog;
...
--
-- Definition for trigger tr_actua_satisfaccion (OID = 23076) : 
--
...
--
-- Definition for trigger tr_cohort_desertion (OID = 23077) : 
--
...
--
-- Definition for trigger tr_period_desertion (OID = 23078) : 
--
...
--
-- Definition for trigger tr_relacion (OID = 23079) : 
--
...
--
-- Definition for trigger tr_est_dep (OID = 23080) : 
--
SET search_path = public, pg_catalog;
...
--
-- Definition for trigger tr_for_dep (OID = 23081) : 
--
...
--
-- Definition for trigger tr_kpi_est_doc (OID = 23082) : 
--
...
--
-- Definition for trigger tr_kpi_est_doc_udenar (OID = 23083) : 
--
...
--
-- Definition for trigger tr_kpi_form (OID = 23084) : 
--
...
--
-- Data for sequence public.estudiantes_departamento_cod_est_dep_seq (OID = 22943)
--
SELECT pg_catalog.setval('estudiantes_departamento_cod_est_dep_seq', 15780, true);
--
-- Data for sequence public.formacion_departamento_cod_forma_dep_seq (OID = 22952)
--
