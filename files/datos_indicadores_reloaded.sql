...
--
-- Definition for function fun_actua_formacion (OID = 27253) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function fun_actua_relacion (OID = 27254) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function fun_delete_cohort (OID = 27255) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function fun_delete_period (OID = 27256) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function Actua_Formacion_Dep (OID = 27257) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function Fun_Actua_KPI_Form (OID = 27258) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function fun_actua_satisfaccion (OID = 27259) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function Actua_Estudiantes_Dep (OID = 27260) : 
--
...
LANGUAGE plpgsql;
--
-- Definition for function Fun_Actua_KPI_Est_Dep (OID = 27261) : 
--
...
LANGUAGE plpgsql;
--
-- Structure for table KPI_Acreditacion (OID = 27262) : 
--
SET search_path = "Datawarehouse", pg_catalog;
...
WITH (oids = false);
--
-- Structure for table KPI_Desercion_Cohorte (OID = 27266) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Desercion_Periodo (OID = 27270) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Estudiantes_por_Docentes_TC (OID = 27274) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Formacion (OID = 27279) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Nivel_Satisfaccion (OID = 27283) : 
--
...
WITH (oids = false);
--
-- Structure for table KPI_Relacion_Docentes (OID = 27287) : 
--
...
WITH (oids = false);
--
-- Structure for table acreditacion_alta_calidad (OID = 27291) : 
--
SET search_path = public, pg_catalog;
...
WITH (oids = false);
--
-- Structure for table formacion (OID = 27312) : 
--
...
WITH (oids = false);
--
-- Structure for table formacion_departamento (OID = 27317) : 
--
...
WITH (oids = false);
--
-- Structure for table manuales_indicadores (OID = 27321) : 
--
...
WITH (oids = false);
--
-- Structure for table poblacion_estudiantes (OID = 27327) : 
--
...
WITH (oids = false);
--
-- Structure for table programas (OID = 27331) : 
--
...
WITH (oids = false);
--
-- Structure for table users (OID = 27336) : 
--
...
WITH (oids = false);
--
-- Definition for view vista_poblacion_docentes (OID = 27343) : 
--
...
--
-- Structure for table estudiantes_departamento (OID = 27350) : 
--
...
\.
--
-- Definition for index poblacion_estudiantes_promedio_key (OID = 27354) : 
--
CREATE UNIQUE INDEX poblacion_estudiantes_promedio_key ON poblacion_estudiantes USING btree (promedio);
--
-- Definition for index KPI_Desercion_Cohorte_idx (OID = 27355) : 
--
SET search_path = "Datawarehouse", pg_catalog;
...
--
-- Definition for index KPI_Formacion_fk (OID = 27402) : 
--
...
--
-- Definition for index KPI_Formacion_fk1 (OID = 27407) : 
--
ALTER TABLE ONLY "KPI_Formacion"
    ADD CONSTRAINT "KPI_Formacion_fk1"
    FOREIGN KEY ("manual_Formacion") REFERENCES public.manuales_indicadores(codigo);
--
-- Definition for index KPI_Nivel_Satisfaccion_fk (OID = 27412) : 
--
ALTER TABLE ONLY "KPI_Nivel_Satisfaccion"
    ADD CONSTRAINT "KPI_Nivel_Satisfaccion_fk"
    FOREIGN KEY (manual) REFERENCES public.manuales_indicadores(codigo);
--
-- Definition for index KPI_Period_Dropout_fk (OID = 27417) : 
--
ALTER TABLE ONLY "KPI_Desercion_Periodo"
    ADD CONSTRAINT "KPI_Period_Dropout_fk"
    FOREIGN KEY (programa) REFERENCES public.programas(snies);
--
-- Definition for index KPI_Relacion_Docentes_fk (OID = 27422) : 
--
...
--
-- Definition for index KPI_Satisfaction_level_fk (OID = 27427) : 
--
ALTER TABLE ONLY "KPI_Nivel_Satisfaccion"
    ADD CONSTRAINT "KPI_Satisfaction_level_fk"
    FOREIGN KEY ("Programa") REFERENCES public.programas(snies);
--
-- Definition for index acreditacion_alta_calidad_fk (OID = 27432) : 
--
SET search_path = public, pg_catalog;
ALTER TABLE ONLY acreditacion_alta_calidad
...
--
-- Definition for trigger tr_cohort_desertion (OID = 27455) : 
--
...
--
-- Definition for trigger tr_period_desertion (OID = 27456) : 
--
...
--
-- Definition for trigger tr_relacion (OID = 27457) : 
--
...
--
-- Definition for trigger tr_for_dep (OID = 27458) : 
--
SET search_path = public, pg_catalog;
...
--
-- Definition for trigger tr_kpi_form (OID = 27459) : 
--
...
--
-- Definition for trigger tr_kpi_est_dep (OID = 27460) : 
--
...
--
-- Definition for trigger tr_est_dep (OID = 27461) : 
--
...
--
-- Data for sequence public.formacion_departamento_cod_forma_dep_seq (OID = 27315)
--
SELECT pg_catalog.setval('formacion_departamento_cod_forma_dep_seq', 11565, true);
--
-- Data for sequence public.estudiantes_departamento_cod_est_dep_seq (OID = 27348)
--
